...
namespace KIOSK.Services
{
    ...
    public sealed class DataBaseService : IDataBaseService, IDisposable
    {
        ...
        public DataBaseService(string? connectionString = null, int commandTimeoutSeconds = 300)
        {
            ...
            _connectionString =
                connectionString ??
                "Server=127.0.0.1;Port=3306;Database=m24h;User ID=root;Password=0304;AllowUserVariables=True;ConnectionReset=false;DefaultCommandTimeout=300;SslMode=None;";
