...
namespace KIOSK.Devices.Drivers
{
    ...
    public sealed class DeviceE200Z : DeviceBase
    {
        ...
        public DeviceE200Z(DeviceDescriptor descriptor, ITransport transport)
        ...
        private async Task ReceiveLoopAsync(CancellationToken ct)
        {
            ...
            while (!ct.IsCancellationRequested)
            {
                ...
                {
                    Log?.Invoke($"[E200Z] ReceiveLoop error: {ex.Message}");
